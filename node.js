...
;
	($.$kimght_limbus_chapter_line) = class $kimght_limbus_chapter_line extends ($.$mol_list) {
		language(next){
			if(next !== undefined) return next;
			return "ru-mtl";
		}
		...
		Picture(){
			...
			(obj.uri) = () => ((this.picture_uri()));
			(obj.title) = () => ("");
			(obj.minimal_width) = () => (128);
			(obj.minimal_height) = () => (128);
			return obj;
		}
		name(){
			return "???";
		...
		ToggleOriginal(){
			...
			(obj.Icon) = () => ((this.ToggleOriginal_icon()));
			(obj.checked) = (next) => ((this.show_original(next)));
			return obj;
		}
		text(){
			return "";
		...
		line(){
			const obj = new this.$.$kimght_limbus_chapter_line_data();
		...
		Speaker(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Picture()), (this.Name())]);
			return obj;
		}
		Controls(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.ToggleOriginal())]);
			return obj;
		}
		Text(){
			const obj = new this.$.$mol_dimmer();
			...
			(obj.style) = () => ({"color": (this.text_color())});
			return obj;
		}
	};
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "language"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Picture"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Name"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "ToggleOriginal_icon"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "show_original"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "ToggleOriginal"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "line"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Place"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Content"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Speaker"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Controls"));
	($mol_mem(($.$kimght_limbus_chapter_line.prototype), "Text"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $kimght_limbus_chapter_line.prototype, "rows", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_chapter_line.prototype, "content", null);
        $$.$kimght_limbus_chapter_line = $kimght_limbus_chapter_line;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $kimght_limbus_character.prototype, "json", null);
    __decorate([
        $mol_mem_key
    ], $kimght_limbus_character, "item", null);
    __decorate([
        $mol_mem_key
...
var $;
(function ($) {
    $.$kimght_limbus_chapter_line_json = $mol_data_record({
    ...
    class $kimght_limbus_chapter_line_data extends $mol_object2 {
        ...
        speaker() {
            if (this.json()?.model) {
                return this.$.$kimght_limbus_character.item({ id: this.json().model, language: this.language() });
            }
        }
        teller() {
            if (this.json()?.teller) {
        ...
        static list({ chapter_id, language }) {
            ...
            const uri = `${chapter_prefix_urls[language]}/${chapter_id}.json`;
            const json = Chapter_data($mol_fetch.json(uri)).dataList;
            let result = [];
            let line_index = 0;
    ...
    __decorate([
        $mol_mem
    ], $kimght_limbus_chapter_line_data.prototype, "text", null);
    __decorate([
        $mol_mem
    ], $kimght_limbus_chapter_line_data.prototype, "color", null);
    __decorate([
        $mol_mem
    ], $kimght_limbus_chapter_line_data.prototype, "json", null);
    __decorate([
        $mol_mem_key
    ], $kimght_limbus_chapter_line_data, "item", null);
    __decorate([
        $mol_mem_key
    ], $kimght_limbus_chapter_line_data, "list", null);
    __decorate([
        $mol_mem_key
    ], $kimght_limbus_chapter_line_data, "length", null);
    $.$kimght_limbus_chapter_line_data = $kimght_limbus_chapter_line_data;
})($ || ($ = {}));
...
;
	($.$kimght_limbus_chapter_page) = class $kimght_limbus_chapter_page extends ($.$mol_page) {
		line(id){
			const obj = new this.$.$kimght_limbus_chapter_line_data();
			return obj;
		}
		...
		Line(id){
			const obj = new this.$.$kimght_limbus_chapter_line();
			(obj.line) = () => ((this.line(id)));
	...
	($mol_mem_key(($.$kimght_limbus_chapter_page.prototype), "line"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Copy_button"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Search_toggle_icon"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "search_enabled"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Search_toggle"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "language"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Language_select"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "search"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "search_end"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Search"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "search_start"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Hotkeys"));
	($mol_mem_key(($.$kimght_limbus_chapter_page.prototype), "Line"));
	($mol_mem(($.$kimght_limbus_chapter_page.prototype), "Lines"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $kimght_limbus_chapter_page.prototype, "lines", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_chapter_page.prototype, "lines_list", null);
        __decorate([
            $mol_mem_key
        ...
        __decorate([
            $mol_mem
        ], $kimght_limbus_chapter_page.prototype, "search_enabled", null);
...
;
	($.$kimght_limbus_story) = class $kimght_limbus_story extends ($.$mol_book2) {
		chapter_slug(id){
			return "";
		}
		item_title(id){
		...
		Item(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"chapter": (this.chapter_slug(id))});
			(obj.sub) = () => ([(this.item_title(id))]);
			return obj;
		}
		tag_name(id){
		...
		Chapters_list_page(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("📕 История");
			(obj.body) = () => ([(this.Chapters_list())]);
			return obj;
		}
		Chapter_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"chapter": (this.chapter_id(id))});
			(obj.sub) = () => ([(this.chapter_title(id))]);
			return obj;
		}
		Chapter_page(id){
			const obj = new this.$.$kimght_limbus_chapter_page();
			(obj.chapter_id) = () => ((this.chapter_id(id)));
			(obj.title) = () => ((this.chapter_title(id)));
			(obj.Next_link) = () => ((this.next_link(id)));
			return obj;
		}
	};
	($mol_mem_key(($.$kimght_limbus_story.prototype), "Item"));
	($mol_mem(($.$kimght_limbus_story.prototype), "Chapters_list"));
	($mol_mem(($.$kimght_limbus_story.prototype), "Chapters_list_page"));
	($mol_mem_key(($.$kimght_limbus_story.prototype), "Chapter_link"));
	($mol_mem_key(($.$kimght_limbus_story.prototype), "Chapter_page"));
...
(function ($) {
    ...
    (function ($$) {
        const Chapters_data = $mol_data_record({
            chapters: $mol_data_array($mol_data_record({
                name: $mol_data_string,
        ...
        class $kimght_limbus_story extends $.$kimght_limbus_story {
            ...
            next_link(id) {
                ...
                if (next_index >= chapter.episodes.length)
                    return null;
        ...
        __decorate([
            $mol_mem_key
        ], $kimght_limbus_story.prototype, "episode_chapter", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_story.prototype, "pages", null);
        __decorate([
            $mol_mem_key
        ], $kimght_limbus_story.prototype, "tag_name", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_story.prototype, "chapter_active", null);
        __decorate([
            $mol_mem_key
        ], $kimght_limbus_story.prototype, "item_title", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_story.prototype, "chapters", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_story.prototype, "toc", null);
        __decorate([
            $mol_mem_key
        ], $kimght_limbus_story.prototype, "chapter_slug", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_story.prototype, "chapter_title", null);
        __decorate([
            $mol_mem
        ], $kimght_limbus_story.prototype, "next_link", null);
        $$.$kimght_limbus_story = $kimght_limbus_story;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
var $;
(function ($) {
    $.$kimght_limbus_identity_json = $mol_data_record({
        id: $mol_data_number,
    ...
    const identity_list_url = "https://raw.githubusercontent.com/x1bViolet/Limbus-Localization-Files/main/Personalities.json";
    ...
    class $kimght_limbus_identity extends $mol_object2 {
        ...
        static list() {
            return Identity_data($mol_fetch.json(this.list_url())).dataList
    ...
    __decorate([
        $mol_mem
    ], $kimght_limbus_identity.prototype, "json", null);
    __decorate([
        $mol_mem_key
    ], $kimght_limbus_identity, "item", null);
    __decorate([
        $mol_mem
...
;
	($.$kimght_limbus_identity_page) = class $kimght_limbus_identity_page extends ($.$mol_book2) {
		...
		identity_base_art_url(id){
			return "null";
		}
		Identity_base_art(id){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.identity_base_art_url(id)));
			(obj.title) = () => ((this.identity_title(id)));
			return obj;
		}
		identity_uptie_art_url(id){
			return "null";
		}
		Identity_uptie_art(id){
			const obj = new this.$.$mol_image();
			(obj.uri) = () => ((this.identity_uptie_art_url(id)));
			(obj.title) = () => ((this.identity_title(id)));
			return obj;
		}
		...
		Identity_page(id){
			const obj = new this.$.$kimght_limbus_chapter_page();
			(obj.chapter_id) = () => ((this.identity_id(id)));
			(obj.title) = () => ((this.identity_title(id)));
			(obj.Art_pre) = () => ((this.Identity_base_art(id)));
			(obj.Art_post) = () => ((this.Identity_uptie_art(id)));
			return obj;
		}
	};
	...
	($mol_mem_key(($.$kimght_limbus_identity_page.prototype), "Identity_uptie_art"));
	($mol_mem(($.$kimght_limbus_identity_page.prototype), "Identities_list_page"));
	($mol_mem_key(($.$kimght_limbus_identity_page.prototype), "Identity_page"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $kimght_limbus_identity_page.prototype, "chapter_active", null);
        __decorate([
            $mol_mem_key
        ], $kimght_limbus_identity_page.prototype, "identity_id", null);
        __decorate([
            $mol_mem_key
        ], $kimght_limbus_identity_page.prototype, "identity_slug", null);
        $$.$kimght_limbus_identity_page = $kimght_limbus_identity_page;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$kimght_limbus_note_page) = class $kimght_limbus_note_page extends ($.$mol_page) {
		...
		tools(){
			return [(this.Search_toggle()), (this.Language_select())];
		}
		head(){
			return [
				(this.Title()), 
...
;
	($.$kimght_app) = class $kimght_app extends ($.$mol_book2_catalog) {
		Theme(){
		...
		Sources(){
			...
			(obj.uri) = () => ("https://github.com/kimght/LimbusCompanyRuMTL");
			return obj;
		}
		Lights(){
		...
		Story(){
			const obj = new this.$.$kimght_limbus_story();
			return obj;
		}
		Identities(){
	...
	($mol_mem(($.$kimght_app.prototype), "Theme"));
	($mol_mem(($.$kimght_app.prototype), "Sources"));
